...
export default function Page() 
{
    ...
    const mobileHeroOpacity = useTransform(scrollYProgress, [0, (1/12)], [1, 0])
    const mobileImageHeroOpacity = useTransform(scrollYProgress, [0, (1/6)], [1, 0])
    ...
    const mobileFirstInView = useInView(mobileFirstTargetRef)
    const mobileSecondInView = useInView(mobileSecondTargetRef)
                ...
                <section className='flex flex-col pt-6 no-scroll-bar md:px-12 snappy'>
                    ...
                    <section className='flex flex-col flex-1 z-30 min-h-[100dvh] max-h-[100dvh] overflow-hidden snappy-section'>
                        ...
                        <section className='relative rounded-t-3xl flex flex-col pt-20 px-4 items-center max-md:gap-6 gapHeroSection flex-1'>
                            ...
                            <div className='flex flex-col justify-center items-center gap-6'>
                                <div className='flex flex-col justify-center items-center py-1 gap-2.5 overflow-hidden'>
                                    <motion.h1 style={{ opacity: mobileHeroOpacity }} initial={{ y: 150, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.75 }} className='text-white font-bold max-md:hidden textHeroSection'>UAE's First fully</motion.h1>
                                    <motion.h1 style={{ opacity: mobileHeroOpacity }} initial={{ y: 150, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.75 }} className='text-white font-bold max-md:hidden textHeroSection'>automated finance app</motion.h1>
                            ...
                            <motion.div initial={{ y: 150, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.75 }} className='flex flex-col items-center justify-center gap-4'>
                                <motion.div style={{ opacity: mobileHeroOpacity }} className='flex items-center justify-between gap-3 max-md:px-6 max-md:h-11'>
                                    <input
                                        type='text'
                                        placeholder='Enter your email'
                                        className='rounded-[0.5rem] max-md:min-h-full emailHeroSection border outline-none border-white w-screen max-w-[180px] sm:max-w-[240px] md:max-w-[468px] bg-[#CBBEBD] text-black placeholder:text-black text-sm' 
                            ...
                            <motion.div style={{ opacity: mobileImageHeroOpacity }}>
                                <Image
                    ...
                    <motion.section ref={secondTargetRef} className={cn('relative flex-1 px-5 flex flex-col items-center justify-center w-full')}>
                        <motion.div initial={{ left: -1000 }} animate={{ left: scrollYProgress.get() >= (5/6)-0.05 ? -1000 : scrollYProgress.get() <= (1/6)+0.005 ? -1000 : opacityBg.get() === 0 ? -1000 : 0 }} transition={{ duration: 0.4 }} style={{ opacity: opacityBg }} className='fixed z-[4] md:-top-[0vh] max-md:-right-10 md:left-0 max-md:max-w-[256px] max-md:max-h-[417px] max-md:scale-x-[-1]'>
                            <Image
                                src='/images/featuresTriangle.png'
                                width={510}
